...
ActiveRecord::Schema.define(:version => 20130326043414) do
  ...
  add_index "relations", ["follower_id", "followed_id", "followed_obj"], :name => "index_relations_on_follower_id_and_followed_id_and_followed_obj", :unique => true
